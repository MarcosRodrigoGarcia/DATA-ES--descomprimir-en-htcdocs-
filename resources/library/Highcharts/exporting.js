                ...
                b = n.defaultOptions; var l = p.doc, t = p.SVG_NS, A = p.win, x = e.addEvent, v = e.css, B = e.createElement, K = e.discardElement,
                    C = e.extend, O = e.find, D = e.fireEvent, P = e.isObject, m = e.merge, Q = e.objectEach, y = e.pick, R = e.removeEvent, S = e.uniqueKey, E; (function (b) {
                        function n(a) {
                            ...
                            var d = a ? a.target : this, b = d.exportSVGElements, c = d.exportDivElements; a = d.expprintortEvents; var l; b && (b.forEach(function (a, c) { a && (a.onclick = a.ontouchstart = null, l = "cache-" + a.menuClassName, d[l] && delete d[l], b[c] = a.destroy()) }), b.length = 0); d.exportingGroup && (d.exportingGroup.destroy(),
